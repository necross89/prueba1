...
<html>
    ...
    <!-------------------------------------- INICIO DE NUESTRO CODIGO -------------------------------------->
                            <div class="text3 p">
                                ...
                                <!-- Esta es una pagina de trancicion entre el index e insertar_ejecutar
                                Es para que el usuario establezca los datos a insertar -->

                                <!-- Esta parte es puro HTML, nada de PHP, es un formulario para llenar -->
                                <form action="insertar_ejecutar.php" method="post" >
                                    <table width="200" border="1" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td colspan="2"><div align="center">Insertar Estudiante</div></td>
                                        </tr>
                                        <tr>
                                            <td>Nombre</td>
                                        ...
                                        <tr>
                                            <td>Indice</td>
                                            <td><input type="text" name="indice" value=""></td>
                                        </tr>
                                        <tr>
                                            <td>Direccion</td>
